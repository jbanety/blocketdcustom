CREATE TABLE IF NOT EXISTS `#__etd_custom` (
  ...
  `block_tag` varchar(3) NOT NULL DEFAULT 'div',
  `title_tag` varchar(3) NOT NULL DEFAULT 'h2',
  `content_tag` varchar(3) NOT NULL DEFAULT 'div',
  `block_class` varchar(50) NOT NULL,
  `title_class` varchar(50) NOT NULL,
  `content_class` varchar(50) NOT NULL,
